	...
	def testPutValidCustomers(self, url):
		...
		if customer:
			...
			try:
				...
				response_content = {}
				response_content['firstName'] = ""
				response_content['lastName'] = ""
				response_content['email'] = ""
			
			# firstname checks
			if 'firstName' in response_content and response_content['firstName'] == self.good_update_list['firstname']['firstname']:
